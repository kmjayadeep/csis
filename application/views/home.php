            ...
            <div class="row">
                ...
                <div class="col-md-3 col-sm-6">
                    <div class="feature">
                       <img src="<?=base_url('assets')?>/ieee/ieee1.gif">
                        ...
                        <p><br><br><br>The IEEE is the world’s largest professional association advancing innovation and technological excellence for the benefit of humanity. Inspiring a global community to innovate for a better tomorrow through its highly-cited publications, conferences, technology standards, and professional and educational activities, IEEE is the trusted “voice” for engineering, computing and technology information around the globe. With more than 430,000 members in more than 160 countries, the IEEE publishes a third of the world’s technical literature and is a leading developer of international standards that underpin many of today's telecommunications, information technology and power generation products and services.</p>
                        <br><br><br><br>
                    </div>
                </div>
                <!--Feature 1 end-->
                ...
                <div class="col-md-3 col-sm-6">
                    ...
                    <img src="<?=base_url('assets')?>/comsoc/comsoc1.gif">
                        ...
                        <p><br><br>The IEEE Computer Society is the world's leading membership organization dedicated to computer science and technology. Serving more than 60,000 members, the IEEE Computer Society is the largest society within IEEE and the trusted information, networking, and career-development source for a global community of technology leaders that includes researchers, educators, software engineers, IT professionals, employers, and students. In addition to more than 200 technical conferences and publishing, the IEEE Computer Society is a leader in professional education and training, and has forged development and provider partnerships with major institutions and corporations internationally.</p>
                    </div>
                </div>
                <!--Feature 2 end-->
                ...
                <div class="row">
                    <div class="col-md-6 col-md-offset-3">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" name="phone" class="form-control" placeholder="Membership ID">
                        </div>
                        <br>
